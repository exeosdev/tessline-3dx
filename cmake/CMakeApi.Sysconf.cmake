...
function( _ebsSysconfDetectTargetPlatform )
    ...
    if( "${CM_EBS_SYSCONF_TARGET_SYSTEM}" STREQUAL "Android" )
        ...
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_GLAPI "EGL" )
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_ANDROID TRUE )
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_POSIX TRUE )
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_VULKAN TRUE )
    elseif( "${CM_EBS_SYSCONF_TARGET_SYSTEM}" STREQUAL "Linux" )
        ...
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_GLAPI "GLX" )
        setInternal( CM_EBS_SYSCONF_TARGET_ARCH_DEFAULT_BIT "64" )
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_POSIX TRUE )
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_VULKAN TRUE )
    elseif( "${CM_EBS_SYSCONF_TARGET_SYSTEM}" STREQUAL "macOS" )
        ...
        setInternal( CM_EBS_SYSCONF_TARGET_ARCH_DEFAULT_64  "x86_64" )
        setInternal( CM_EBS_SYSCONF_TARGET_ARCH_DEFAULT_BIT "64" )
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_GLAPI "AGL" )
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_APPLE TRUE )
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_POSIX TRUE )
    ...
    elseif( "${CM_EBS_SYSCONF_TARGET_SYSTEM}" STREQUAL "WinDesktop" )
        ...
        setInternal( CM_EBS_SYSCONF_TARGET_ARCH_DEFAULT_64  "x86_64" )
        setInternal( CM_EBS_SYSCONF_TARGET_ARCH_DEFAULT_BIT "64" )
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_GLAPI "WGL" )
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_WINFAMILY TRUE )
        setInternal( CM_EBS_SYSCONF_TARGET_FLAG_OSF_VULKAN TRUE )
