...
#ifndef __TS3DRIVER_GPUAPI_GLCOMMON_COMMON_DEFSH__
#define __TS3DRIVER_GPUAPI_GLCOMMON_COMMON_DEFSH__
...
#define GL_TEXFMT_COMPRESSED_BC2_SRGB    GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT
...
namespace ts3::gpuapi
{
	...
	inline constexpr GLenum cvGLInvalidValue = ts3::Limits<GLenum>::maxValue;

	inline constexpr GLuint cvGLInvalidProgramLocation = ts3::Limits<GLuint>::maxValue;
