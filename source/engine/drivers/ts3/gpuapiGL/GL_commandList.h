...
namespace ts3::gpuapi
{
	...
	{
	public:
		system::GLRenderContextHandle const mSysGLRenderContext;

	public:
		GLCommandList( GLCommandSystem & pGLCommandSystem, ECommandListType pListType, system::GLRenderContextHandle pSysGLRenderContext );
