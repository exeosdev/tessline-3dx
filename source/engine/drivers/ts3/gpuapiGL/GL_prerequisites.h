...
#define TS3GX_GL_PLATFORM_TYPE_DESKTOP 0x7100
...
#  define TS3GX_GL_PLATFORM_TYPE TS3GX_GL_PLATFORM_TYPE_DESKTOP
...
#if ( TS3GX_GL_PLATFORM_TYPE == TS3GX_GL_PLATFORM_TYPE_DESKTOP ) && defined( TS3_DRIVER_GPUAPI_GL3_BUILD )
#  define TS3GX_GL_TARGET TS3GX_GL_TARGET_GL32
#endif
#if ( TS3GX_GL_PLATFORM_TYPE == TS3GX_GL_PLATFORM_TYPE_DESKTOP ) && defined( TS3_DRIVER_GPUAPI_GL4_BUILD )
...
#define TS3GX_GL_FEATURE_SUPPORT_DEBUG_OUTPUT \
	( TS3_SYSTEM_GL_PLATFORM_TYPE == TS3_SYSTEM_GL_PLATFORM_TYPE_DESKTOP )
...
#define TS3GX_GL_FEATURE_SUPPORT_SHADER_PIPELINE_OBJECT \
