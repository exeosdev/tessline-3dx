...
namespace ts3::gpuapi
{
	...
	enum EGPUResourceMemoryFlags : resource_flags_value_t
	{
		E_GPU_RESOURCE_MEMORY_MASK_DEFAULT =
			...
			E_MEMORY_HEAP_PROPERTY_FLAG_CPU_CACHED_BIT,

		E_GPU_RESOURCE_MEMORY_MASK_CONSTANT_BUFFER =
			E_MEMORY_ACCESS_FLAG_CPU_WRITE_BIT |
			E_MEMORY_ACCESS_FLAG_GPU_READ_BIT |
	...
	using ResourceMapPtr = typename Internal::ResourceMapPtrTypeProxy<TpData, ( tAccessMask & E_MEMORY_MAP_FLAG_ACCESS_WRITE_BIT ) != 0>;
