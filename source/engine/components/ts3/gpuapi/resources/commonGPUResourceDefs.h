...
namespace ts3::gpuapi
{
	...
	enum EGPUResourcEGPUMemoryFlags : resource_flags_value_t
	{
		...
		E_GPU_RESOURCE_GPU_MEMORY_MASK_CONSTANT_BUFFER =
			E_GPU_MEMORY_ACCESS_FLAG_CPU_WRITE_BIT |
			E_GPU_MEMORY_ACCESS_FLAG_GPU_READ_BIT |
			E_GPU_MEMORY_HEAP_PROPERTY_FLAG_CPU_COHERENT_BIT,

		E_GPU_RESOURCE_GPU_MEMORY_MASK_VERTEX_STREAM_BUFFER_DYNAMIC =
			E_GPU_MEMORY_ACCESS_FLAG_CPU_WRITE_BIT |
			E_GPU_MEMORY_ACCESS_FLAG_GPU_READ_BIT |
			E_GPU_MEMORY_HEAP_PROPERTY_FLAG_CPU_CACHED_BIT,

		E_GPU_RESOURCE_GPU_MEMORY_MASK_VERTEX_STREAM_BUFFER_STATIC =
			E_GPU_MEMORY_ACCESS_FLAG_GPU_READ_BIT |
			E_GPU_MEMORY_HEAP_PROPERTY_FLAG_CPU_CACHED_BIT,

		E_GPU_RESOURCE_GPU_MEMORY_MASK_TRANSFER_SOURCE_BUFFER =
			E_GPU_MEMORY_ACCESS_FLAG_CPU_WRITE_BIT |
			E_GPU_MEMORY_HEAP_PROPERTY_FLAG_CPU_CACHED_BIT,

		E_GPU_RESOURCE_GPU_MEMORY_MASK_TRANSFER_TARGET_BUFFER =
			E_GPU_MEMORY_ACCESS_FLAG_GPU_READ_BIT,
	};
