...
namespace ts3::gpuapi
{
	...
	inline constexpr uint32 cvTextureMipLevelAll = ts3::Limits<uint32>::maxValue;
	...
	{
		E_TEXTURE_DATA_COPY_FLAG_MODE_INVALIDATE_BIT = E_MEMORY_MAP_FLAG_WRITE_INVALIDATE_BIT,
