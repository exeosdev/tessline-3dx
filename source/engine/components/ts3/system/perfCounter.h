...
namespace system
{
	...
	public:
		...
		static long double convertToDuration( perf_counter_value_t pStampDiff, const std::pair<native_int, native_int> & pUnitRatio );
		...
		static perf_counter_value_t convertFromDuration( long double pDuration, const std::pair<native_int, native_int> & pUnitRatio );
		...
		static long double convertToDuration( perf_counter_value_t pStampDiff )
		{
		...
		template <DurationPeriod tpPeriod>
		static perf_counter_value_t convertFromDuration( const Duration<tpPeriod> & pDuration )
		{
