...
namespace ts3::system
{
	...
	TS3_SYSTEM_API_NODISCARD perf_counter_value_t crmPerfCounterQueryCurrentStamp();

	/// @brief Returns the resolution of a counter as a number of units which elapse during a period of one second.
	TS3_SYSTEM_API_NODISCARD perf_counter_res_t crmPerfCounterQueryResolution();
	...
	TS3_SYSTEM_API_NODISCARD long double crmPerfCounterConvertToDuration( perf_counter_value_t pStampDiff, const std::pair<native_int, native_int> & pUnitRatio );
	...
	TS3_SYSTEM_API_NODISCARD perf_counter_value_t crmPerfCounterConvertFromDuration( long double pDuration, const std::pair<native_int, native_int> & pUnitRatio );
