...
namespace ts3::system
{
    ...
    /// @brief Queries and returns the current value of a system-specific, high-performance clock.
        ...
        TS3_SYSTEM_API_NODISCARD static long double convertToDuration( perf_counter_value_t pStampDiff, const std::pair<native_int, native_int> & pUnitRatio );
        ...
        TS3_SYSTEM_API_NODISCARD static perf_counter_value_t convertFromDuration( long double pDuration, const std::pair<native_int, native_int> & pUnitRatio );
