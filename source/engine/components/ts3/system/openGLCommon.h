...
namespace ts3::system
{
    ...
    enum : exception_code_value_t
    {
        ...
        E_EXCEPTION_CODE_SYSTEM_OPENGL_SUBSYS_AGL_ERROR = ecDeclareExceptionCode( E_EXCEPTION_CATEGORY_SYSTEM_OPENGL, 0xE1 ),
        E_EXCEPTION_CODE_SYSTEM_OPENGL_SUBSYS_EGL_ERROR = ecDeclareExceptionCode( E_EXCEPTION_CATEGORY_SYSTEM_OPENGL, 0xE2 ),
        E_EXCEPTION_CODE_SYSTEM_OPENGL_SUBSYS_GLX_ERROR = ecDeclareExceptionCode( E_EXCEPTION_CATEGORY_SYSTEM_OPENGL, 0xE3 ),
        E_EXCEPTION_CODE_SYSTEM_OPENGL_SUBSYS_WGL_ERROR = ecDeclareExceptionCode( E_EXCEPTION_CATEGORY_SYSTEM_OPENGL, 0xE4 )
    };
