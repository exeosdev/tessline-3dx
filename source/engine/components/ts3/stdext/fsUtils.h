...
#ifndef __TS3_STDEXT_FS_UTILS_H__
#define __TS3_STDEXT_FS_UTILS_H__
...
namespace ts3
{
    ...
    public:
        enum EFlags : uint32
        {
            ...
            E_SPLIT_PATH_MASK_ALL = E_SPLIT_PATH_FLAG_ASSUME_DIRECTORY_BIT |
...
#endif // __TS3_STDEXT_FS_UTILS_H__
