...
typedef enum VkResult {
    ...
    VK_ERROR_E_MEMORY_MAP_FAILED = -5,
...
typedef VkFlags VkEMemoryMapFlags;
...
typedef enum VkShaderStageFlagBits {
    ...
    VK_E_SHADER_STAGE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF
...
typedef VkFlags VkEShaderStageFlags;
...
typedef VkResult (VKAPI_PTR *PFN_vkMapMemory)(VkDevice device, VkDeviceMemory memory, VkDeviceSize offset, VkDeviceSize size, VkEMemoryMapFlags flags, void** ppData);
...
typedef void (VKAPI_PTR *PFN_vkCmdPushConstants)(VkCommandBuffer commandBuffer, VkPipelineLayout layout, VkEShaderStageFlags stageFlags, uint32_t offset, uint32_t size, const void* pValues);
...
typedef struct VkPhysicalDeviceSubgroupProperties {
    ...
    VkEShaderStageFlags        supportedStages;
...
typedef struct VkPhysicalDeviceVulkan11Properties {
    ...
    VkBool32                   deviceLUIDValid;
    uint32_t                   subgroupSize;
    VkEShaderStageFlags         subgroupSupportedStages;
...
typedef struct VkShaderStatisticsInfoAMD {
    VkEShaderStageFlags          shaderStageMask;
...
typedef struct VkPhysicalDeviceSubgroupSizeControlPropertiesEXT {
    ...
    VkEShaderStageFlags    requiredSubgroupSizeStages;
...
typedef struct VkPhysicalDeviceCooperativeMatrixPropertiesNV {
    VkStructureType       sType;
    void*                 pNext;
    VkEShaderStageFlags    cooperativeMatrixSupportedStages;
...
typedef struct VkIndirectCommandsLayoutTokenNV {
    ...
    VkEShaderStageFlags               pushconstantEShaderStageFlags;
